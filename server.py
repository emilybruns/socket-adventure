...
class Server(object):
    ...
    * self.room: one of 0, 1, 2, 3. This signifies which "room" the client is in,
    ...
    def room_description(self, room_number):
        ...
        return [
            "You are in the room filled with spiders.",
            "You are in the room with the quicksand floor.",
            "You are in the room filled with stuffed animals.",
            "You are in the room with a swimming pool and chocolate fountain.",
        ][room_number]
